...
public final class ItemNotesBinding implements ViewBinding {
  ...
  private ItemNotesBinding(@NonNull LinearLayout rootView, @NonNull TextView mNote) {
  ...
  public static ItemNotesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.mNote;
      TextView mNote = ViewBindings.findChildViewById(rootView, id);
      if (mNote == null) {
        break missingId;
      }

      return new ItemNotesBinding((LinearLayout) rootView, mNote);
    }
